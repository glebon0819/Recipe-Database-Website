...
<body>
    ...
    <div class="container">
            <div class="row">
                <h3>Victoria and Gabriel's Dank Meme Stash</h3>
            </div>
            <div class="row">
                ...
                <table class="table table-striped table-bordered">
                  ...
                  <?php
                   ...
                   foreach ($pdo->query($sql) as $row) {
                            ...
                            echo '<td><a href="pages/chef.php?chef='. $row['chef'] .'">'. $row['chef'] . '</a></td>';
                            echo '<td><a href="pages/recipe.php?id='. $row['id'] .'">'. $row['name'] . '</a></td>';
